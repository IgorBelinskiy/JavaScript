...
var Slider = /*#__PURE__*/function () {
  ...
  _createClass(Slider, [{
    ...
    value: function nextSlide() {
      console.log('Mooving forward');
    }
  }, {
    key: "prevSlide",
    value: function prevSlide() {
      console.log('Mooving back');
    }
  }, {
    key: "WhoAmI",
  ...
  return Slider;
}(); // let slid = new Slider(600, 500, 5),
//    newSlid = new Slider(300, 200, 4);
// slid.WhoAmI();
// newSlid.WhoAmI();
...
var AutoSlider = /*#__PURE__*/function (_Slider) {
  ...
  return AutoSlider;
}(Slider); // const slid = new AutoSlider(500, 500, 4, true);
// slid.WhoAmI();
// slid.play();
